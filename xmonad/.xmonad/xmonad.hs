...
myStartupHook = do
    ...
    spawnOnce "dunst &"
    spawnOnce "battery_charge_notifier.py -d 5 -l 15 -f 98"
...
myWorkspaces = [" dev ", " www ", " sys ", " chat ", " mus ", " vid ", " oth ", " sht ", " xxx "]
...
myKeys =
    ...
    -- KB_GROUP Multimedia Keys
        ...
        , ("<Print>", spawn "bash $HOME/.local/bin/takeAreaScreenshot")
        , ("<F9>", spawn "light -U 10")
