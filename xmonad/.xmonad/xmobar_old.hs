...
Config { font            = "xft:Hasklug Nerd Font:weight=bold:pixelsize=11:antialias=true:hinting=true"
       ...
       , commands = [
                    ...
                    , Run Com "echo" ["<icon=$HOME/.xmonad/icons/eye.xbm"] "eye" 20
                    , Run Com "$HOME/.local/bin/showBrightness" [] "showBrightness", 20
